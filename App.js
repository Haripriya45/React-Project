...
import ContactAPI from './API Reactjs Project/ContactAPI';
import BMIAPI from './API Reactjs Project/BMIAPI';
import HomeAPI from './API Reactjs Project/HomeAPI';
import API from './API Reactjs Project/API';

import WeatherAPI from './API Reactjs Project/WeatherAPI.js';
import NewsAPI from './API Reactjs Project/NewsAPI';
import MovieAPI from './API Reactjs Project/MovieAPI';
import ProductsAPI from './API Reactjs Project/ProductsAPI';
import FoodAPI from './API Reactjs Project/FoodAPI.js';
